...
export default function VolunteerDashboard() {
  ...
  return (
    <div className="flex flex-col lg:flex-row p-6 lg:space-x-16">
      {/* Left Side - Table */}
      ...
      <div className="w-full lg:w-1/4 flex flex-col items-center mt-10 lg:mt-0 lg:ml-16 space-y-6">
        <div className="relative w-40 h-40 flex justify-center items-center border-4 border-gray-700 rounded-full">
          <span className="text-2xl font-bold">{totalHours.toFixed(2)} hrs</span>
        </div>
